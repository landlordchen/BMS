var contabs = function(){
	...
	function n() {
		...
		if ($(".J_menuTab").each(function() {
			return $(this).data("id") == t ? (($(this).addClass("active").siblings(".J_menuTab").removeClass("active"), e(this), $(".J_mainContent .J_iframe").each(function() {
				return $(this).data("id") == t ? ($(this).show().attr("src",t).load().siblings(".J_iframe").hide(), !1) : void 0
			})), n = !1, !1) : void 0
		}), n) {
			...
			var o = layer.load({shade: [0.8, '#393D49']});
	...
	function init(){
		...
		$("#side-menu").on("click",".J_menuItem", n), 
	...
	return {
		init:function(){init();},
		initDataId:function(){initDataId();}
	}
}();
