...
<!-- 权限编辑js导入 -->
<script type="text/javascript" src="${js}/rdp/role/user_perm_edit.js"></script>
</head>
<body onload="load()">
	<form method="post" action="${ctx}/role/modifyRoleInfo.htm" id="edit_form">
		<input type="hidden" name="roleId" id="roleId" value="<%=USER_ID%>" />
