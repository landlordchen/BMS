...
<IFRAME height="100%" width="100%"  frameBorder=0 id=frmleft name=frmleft src="${ctx}/jsp/customerTree.jsp?funcid=<%=request.getParameter("funcid")%>&tenderid=<%=request.getParameter("tenderid")%>"  allowTransparency="true"></IFRAME>
</div>
...
<IFRAME height="100%" width="100%" frameBorder=0 id="frmright1" name=frmright1 src="/sfsc.ztb/ShowReport.wx?PAGEID=tenderInfoEdit&report1_ACCESSMODE=readonly&report2_ACCESSMODE=readonly&hideRp2=1&TENDER_ID=<%=request.getParameter("tenderid")%>"  allowTransparency="true"></IFRAME>
</div>
</div>				
</body> 
</html>